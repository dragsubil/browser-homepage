...
function setup(){
    ...
    options.Color1 = [random(0,255),random(0,255),random(0,255), 0];
    options.Color2 = [random(0,255),random(0,255),random(0,255), 0];
    options.Color3 = [random(0,255),random(0,255),random(0,255), 0];
